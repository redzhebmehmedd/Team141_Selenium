...
public class C01_Xparh_TextKullanimi {
    public static void main(String[] args) throws InterruptedException {
        ...
        if (removeButonu.isDisplayed()){
            System.out.println("remove buton görünme testi Passed");
        }else {System.out.println("remove buton gorunme tessi failled");}
